...
// 2. Xây dựng câu SQL - Bắt đầu với phần SELECT và WHERE cơ bản
...
// 4. Nối thêm điều kiện lọc Tìm kiếm
if ($search_query != '') {
    $sql .= " AND p.ten LIKE '%$search_query%'";
}

// 5. Nối thêm duy nhất MỘT điều kiện Sắp xếp (ORDER BY)
switch ($sort_type) {
    case 'price_asc':
...
// 6. Nếu là mục 'new' thì giới hạn 8 món ở cuối cùng
if ($current_cat == 'new') {
    $sql .= " LIMIT 8";
}
            ...
            <div class="ms-auto d-flex align-items-center gap-3">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-4 mt-2 py-2 sort-menu">
                        <li><a class="dropdown-item sort-item active-sort" href="<?php echo buildUrl(array('sort'=>'newest')); ?>">Featured</a></li>
                        <li>
                            <hr class="dropdown-divider mx-2">
                        </li>
                        <li><a class="dropdown-item sort-item" href="<?php echo buildUrl(array('sort'=>'name_asc')); ?>" onclick="selectSort(this)">Alphabetical, A-Z</a>
                        </li>
                        <li><a class="dropdown-item sort-item" href="<?php echo buildUrl(array('sort'=>'name_desc')); ?>" onclick="selectSort(this)">Alphabetical, Z-A</a>
                        </li>
                        <li><a class="dropdown-item sort-item" href="<?php echo buildUrl(array('sort'=>'price_asc')); ?>" onclick="selectSort(this)">Price, Low to
                                High</a></li>
                        <li><a class="dropdown-item sort-item" href="<?php echo buildUrl(array('sort'=>'price_desc')); ?>" onclick="selectSort(this)">Price, High to
                                Low</a></li>
                    </ul>
                </div>
            </div>
